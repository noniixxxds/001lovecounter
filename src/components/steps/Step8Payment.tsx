...
const Step8Payment: React.FC<StepProps> = ({ formData, updateFormData, onNext, onBack, isFirst, isLast }) => {
  ...
  const fullSiteUrl = `https://nutrihub.com/plano/${siteUrl}`;

  return (
    <div className="form-step">
      <h1 className="text-xl font-bold text-white mb-2">Finalizar plano</h1>
      <p className="text-gray-300 mb-6 text-sm">
        {isSaving ? 'Salvando seu plano...' : siteSaved ? 'Seu plano foi criado com sucesso!' : 'Criando seu plano...'}
      </p>
      ...
      {isSaving && (
        <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4 mb-6">
          ...
          <span className="text-blue-300 font-semibold text-sm">Salvando seu plano alimentar...</span>
        </div>
      ...
      {siteSaved && siteUrl && (
        <div className="bg-green-900/20 border border-green-700 rounded-lg p-4 mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-green-300 font-semibold text-sm">Plano criado com sucesso!</span>
          </div>
          <p className="text-gray-300 text-xs mb-3">
            Seu plano está disponível no link abaixo:
          </p>
          ...
          <p className="text-green-300 text-xs">
            ✅ Você pode acessar seu plano mesmo sem efetuar o pagamento!
          </p>
        </div>
      )}
      ...
      <div className="bg-gray-800 rounded-lg p-4 mb-6">
        <h2 className="text-lg font-bold text-white mb-3">Resumo do plano</h2>
        ...
        <div className="flex items-center gap-3 bg-orange-900/20 border border-orange-700 rounded-lg p-3">
          ...
          <div className="flex-1">
            <p className="text-orange-300 font-semibold text-sm">Oferta especial de lançamento</p>
      ...
      <div className="bg-gray-800 rounded-lg p-4 mb-6">
        ...
        <div className="space-y-3 mb-4">
          ...
          >
            ...
            {paymentMethod === 'pix' && <span className="ml-auto text-emerald-400">✓</span>}
          </button>
          ...
          >
            ...
            {paymentMethod === 'credit' && <span className="ml-auto text-emerald-400">✓</span>}
          </button>
        </div>
          ...
          <div className="space-y-3 mb-4">
            <div>
              ...
              <input
                ...
                maxLength={14}
                className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:border-emerald-500 transition-colors"
              />
            </div>
